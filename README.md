<a href="https://github.com/dmzoneill" target="_blank"><img alt="Github" src="https://img.shields.io/badge/GitHub-%2312100E.svg?&style=for-the-badge&logo=Github&logoColor=white" /></a> &nbsp;&nbsp; <a href="https://www.linkedin.com/in/dmzoneill/" target="_blank"><img alt="LinkedIn" src="https://img.shields.io/badge/linkedin-%230077B5.svg?&style=for-the-badge&logo=linkedin&logoColor=white" /></a> &nbsp;&nbsp; <img alt="Github" src="https://img.shields.io/badge/Last%20Updated-06/09/2026 12:11:55-brightgreen" height='28'/> &nbsp;&nbsp; <img alt="Profile Views" src="https://komarev.com/ghpvc/?username=dmzoneill&color=brightgreen&style=for-the-badge" height='28'/> &nbsp;&nbsp; <img alt="Redhat" width='30' height='25' src="https://github.com/dmzoneill/dmzoneill/blob/main/images/redhat.svg?raw=true" />
...
<ul><li><a href='https://github.com/dmzoneill/Leecharr/issues/302'>[Bug] QBittorrentApiController setShareLimits stores seedingTimeLimit (seconds) directly as TargetSeedTimeMinutes, 60x scale error</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/303'>[Bug] CategoryService.Delete() doesn't migrate torrents to default category — dangling references break seed limits and save paths</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/301'>[Bug] TorrentTable ETA sort comparator produces NaN when downloadSpeed > 0 but progress/totalSize are undefined, breaking Array.sort ordering</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/301'>[Bug] TorrentTable ETA sort comparator produces NaN when downloadSpeed > 0 but progress/totalSize are undefined, breaking Array.sort ordering</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/298'>[Security] WebhookDispatcher logs raw customHeadersJson including Authorization/Bearer tokens and API keys at Warn level</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/302'>[Bug] QBittorrentApiController setShareLimits stores seedingTimeLimit (seconds) directly as TargetSeedTimeMinutes, 60x scale error</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/300'>[Bug] PieceMapSignalREventHandler.Dispose() races with timer callback, throwing ObjectDisposedException on flushLock.Release()</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/300'>[Bug] PieceMapSignalREventHandler.Dispose() races with timer callback, throwing ObjectDisposedException on flushLock.Release()</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/299'>[Bug] speedPulse ETA in AppLifetime.cs reconstructs totalBytes via dlBytes/progress, producing garbage ETA when progress rounds to tiny fractions</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/299'>[Bug] speedPulse ETA in AppLifetime.cs reconstructs totalBytes via dlBytes/progress, producing garbage ETA when progress rounds to tiny fractions</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/297'>[Bug] SpeedGraph.tsx uses hardcoded global SVG gradient IDs, causing gradient collisions across multiple instances</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/298'>[Security] WebhookDispatcher logs raw customHeadersJson including Authorization/Bearer tokens and API keys at Warn level</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/297'>[Bug] SpeedGraph.tsx uses hardcoded global SVG gradient IDs, causing gradient collisions across multiple instances</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/295'>[Bug] RssSyncService in-memory grabbedReleaseIds dictionary lost on restart, creating duplicate DownloadHistory entries on re-grab</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/297'>[Bug] SpeedGraph.tsx uses hardcoded global SVG gradient IDs, causing gradient collisions across multiple instances</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/294'>[Bug] TorrentTable.tsx leaks document mousemove/mouseup event listeners on unmount during column resize</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/295'>[Bug] RssSyncService in-memory grabbedReleaseIds dictionary lost on restart, creating duplicate DownloadHistory entries on re-grab</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/294'>[Bug] TorrentTable.tsx leaks document mousemove/mouseup event listeners on unmount during column resize</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/293'>[Bug] FFprobeInspectorProvider.InspectFile and MediaInfoInspectorProvider.InspectFile block thread pool threads via sync-over-async antipattern, causing thread starvation under concurrent media enrichment</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/292'>[Security] BackupController pg_dump/psql arguments vulnerable to config injection via restored config.xml</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/293'>[Bug] FFprobeInspectorProvider.InspectFile and MediaInfoInspectorProvider.InspectFile block thread pool threads via sync-over-async antipattern, causing thread starvation under concurrent media enrichment</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/291'>[Security] SAML callback missing SubjectConfirmationData Recipient and AudienceRestriction validation — assertion replay risk</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/292'>[Security] BackupController pg_dump/psql arguments vulnerable to config injection via restored config.xml</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/290'>[Bug] PtyTerminalService.IsTerminalAccessPermitted always returns true — terminal access control is a no-op</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/291'>[Security] SAML callback missing SubjectConfirmationData Recipient and AudienceRestriction validation — assertion replay risk</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/290'>[Bug] PtyTerminalService.IsTerminalAccessPermitted always returns true — terminal access control is a no-op</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/290'>[Bug] PtyTerminalService.IsTerminalAccessPermitted always returns true — terminal access control is a no-op</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/296'>[Bug] PeerConnectionHistoryService.Purge() silently drops events enqueued during concurrent RecordEvent calls</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/289'>[Security] CSP allows 'unsafe-eval' in script-src — weakens XSS mitigation in production build</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/296'>[Bug] PeerConnectionHistoryService.Purge() silently drops events enqueued during concurrent RecordEvent calls</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/289'>[Security] CSP allows 'unsafe-eval' in script-src — weakens XSS mitigation in production build</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/288'>[Security] Master API key accepted in query parameters — credential leakage via logs, browser history, and Referer headers</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/288'>[Security] Master API key accepted in query parameters — credential leakage via logs, browser history, and Referer headers</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/288'>[Security] Master API key accepted in query parameters — credential leakage via logs, browser history, and Referer headers</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/281'>[Security] DOM XSS in FileBrowser.tsx via unsanitized innerHTML (reflected path parameter and entry names)</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/281'>[Security] DOM XSS in FileBrowser.tsx via unsanitized innerHTML (reflected path parameter and entry names)</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/281'>[Security] DOM XSS in FileBrowser.tsx via unsanitized innerHTML (reflected path parameter and entry names)</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/280'>[Security] FileBrowserService allows arbitrary filesystem read/delete/create/rename with no path confinement</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/280'>[Security] FileBrowserService allows arbitrary filesystem read/delete/create/rename with no path confinement</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/279'>[Security] Unauthenticated auth bypass via ForwardAuth header spoofing - Cleared KnownProxies/Networks allows Remote-User spoof from internet</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/280'>[Security] FileBrowserService allows arbitrary filesystem read/delete/create/rename with no path confinement</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/282'>[Security] Broken access control: RequireAdmin/Operator role policies never enforced on any endpoint</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/279'>[Security] Unauthenticated auth bypass via ForwardAuth header spoofing - Cleared KnownProxies/Networks allows Remote-User spoof from internet</a></li></ul>
</details>
<details>
...
<table width='100%' style='width:100%'>
  ...
  <tbody>
    <tr><td><img src='https://img.shields.io/badge/c%23-%23239120.svg?style=for-the-badge&logo=c-sharp&logoColor=white' title='C#'  height='20px'/></td><td>9480191</td>
<td><img src='https://img.shields.io/badge/typescript-%23007ACC.svg?style=for-the-badge&logo=typescript&logoColor=white' title='TypeScript'  height='20px'/></td><td>4547066</td>
...
<tr>
            ...
            <td>
              ...
              <p>Apache License 2.0</p>
              <p><h4>Recent Activity</h4><ul><li><a href='https://github.com/dmzoneill/Leecharr/issues/302'>[Bug] QBittorrentApiController setShareLimits stores seedingTimeLimit (seconds) directly as TargetSeedTimeMinutes, 60x scale error</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/303'>[Bug] CategoryService.Delete() doesn't migrate torrents to default category — dangling references break seed limits and save paths</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/301'>[Bug] TorrentTable ETA sort comparator produces NaN when downloadSpeed > 0 but progress/totalSize are undefined, breaking Array.sort ordering</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/301'>[Bug] TorrentTable ETA sort comparator produces NaN when downloadSpeed > 0 but progress/totalSize are undefined, breaking Array.sort ordering</a></li></ul></p>
