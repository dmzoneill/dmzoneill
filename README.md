<a href="https://github.com/dmzoneill" target="_blank"><img alt="Github" src="https://img.shields.io/badge/GitHub-%2312100E.svg?&style=for-the-badge&logo=Github&logoColor=white" /></a> &nbsp;&nbsp; <a href="https://www.linkedin.com/in/dmzoneill/" target="_blank"><img alt="LinkedIn" src="https://img.shields.io/badge/linkedin-%230077B5.svg?&style=for-the-badge&logo=linkedin&logoColor=white" /></a> &nbsp;&nbsp; <img alt="Github" src="https://img.shields.io/badge/Last%20Updated-17/09/2026 18:11:52-brightgreen" height='28'/> &nbsp;&nbsp; <img alt="Profile Views" src="https://komarev.com/ghpvc/?username=dmzoneill&color=brightgreen&style=for-the-badge" height='28'/> &nbsp;&nbsp; <img alt="Redhat" width='30' height='25' src="https://github.com/dmzoneill/dmzoneill/blob/main/images/redhat.svg?raw=true" />
...
<ul><li><a href='https://github.com/dmzoneill/ansible-feeditout-com/issues/454'>[ALERT] SystemdUnitFailed — </a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/430'>fix(encryption): fix IA buffer size limit to 65535 bytes and pipeline outgoing BitTorrent handshakes in MSE IA payload</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/433'>feat(simulation): enforce swarm physical speed ceilings, zero-leecher upload suppression, and warm-up ramp curves</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/431'>security(encryption): enforce strict single-bit crypto_select validation and prevent downgrade attacks in RequireEncrypted mode</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/435'>feat(simulation): implement tracker warning circuit breaker, monotonic byte safeguards, and statistical announce interval jitter</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/432'>perf(encryption): optimize RC4 stream cipher with in-place unrolled processing to reduce CPU overhead on high-speed transfers</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/453'>fix(relocation): implement multi-file atomic rollback on move failure and sanitize Windows reserved filenames</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/436'>feat(tags): implement rule-based AutoTaggerService for dynamic media classification and tracker domain matching</a></li><li><a href='https://github.com/dmzoneill/ansible-feeditout-com/issues/454'>[ALERT] SystemdUnitFailed — </a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/452'>fix(relocation): enforce active I/O locking, peer choking, and open file handle teardown during torrent relocation</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/437'>feat(tags): implement tag-based seeding policies, bandwidth limits, color customization, and bulk tag endpoints</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/451'>feat(relocation): implement resilient cross-filesystem file mover with EXDEV copy-verify-delete fallback and progress reporting</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/434'>security(trackers): align HTTP announce parameter ordering, case-sensitive escaping, and 32-bit key injection with emulated client profiles</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/462'>feat(streaming): implement playback head sliding window piece picking for HTTP 206 live media preview</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/454'>security(trackerserver): enforce torrent registration checks in private tracker mode for HTTP and UDP announces</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/438'>feat(webseed): implement BEP 17 Hoffman-style HTTP seeding (httpseeds) and dual BEP 17/19 metainfo parsing</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/439'>fix(webseed): enforce RFC 3986 URI percent-encoding for multi-file subpaths and unicode characters</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/460'>feat(pieces): implement strict sequential piece picking with rarest-first swarm balancing</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/440'>fix(webseed): handle HTTP 301/302/307/308 redirects with Range header preservation and loop guards</a></li><li><a href='https://github.com/dmzoneill/ansible-feeditout-com/issues/454'>[ALERT] SystemdUnitFailed — </a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/441'>perf(webseed): implement piece-level HTTP range chunking and persistent connection pooling to eliminate TCP/TLS handshake latency</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/442'>feat(queue): implement category-level concurrency slot limits and reserved download slots</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/445'>feat(dht): implement BEP 42 IP-based Node ID verification and persistent DHT state to prevent Sybil attacks</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/443'>perf(queue): implement atomic BatchMoveQueue to eliminate N*M database lock thrashing in QBittorrent and Transmission RPC</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/446'>perf(dht): replace O(N log N) full-table sorting in GetClosestNodes with prefix-tree K-bucket traversal</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/447'>fix(dht): enforce strict per-infohash and global storage caps in DhtPeerStore to prevent memory exhaustion</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/444'>feat(bandwidth): implement Weighted Fair Queueing (WFQ) with minimum transmission floor to prevent low-priority swarm starvation</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/448'>fix(deluge): enforce RFC-compliant JSON-RPC error object structure and support user password authentication in auth.login</a></li><li><a href='https://api.github.com/repos/dmzoneill/Seedarr'>dmzoneill/Seedarr</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/449'>feat(dht): implement DHT routing table state persistence (dht.dat) and redundant bootstrap fallback</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/457'>perf(trackerserver): implement in-memory scrape caching and concurrency limits to prevent lock starvation</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/450'>fix(deluge): implement file priority persistence in core.set_torrent_file_priorities and project files and trackers in torrent status</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/458'>feat(arr): implement ReadarrConnection provider, API v1 history routing, and book/comic metadata modeling</a></li></ul>
</details>
<details>
...
<table width='100%' style='width:100%'>
  ...
  <tbody>
    <tr><td><img src='https://img.shields.io/badge/c%23-%23239120.svg?style=for-the-badge&logo=c-sharp&logoColor=white' title='C#'  height='20px'/></td><td>17387005</td>
<td><img src='https://img.shields.io/badge/typescript-%23007ACC.svg?style=for-the-badge&logo=typescript&logoColor=white' title='TypeScript'  height='20px'/></td><td>12066289</td>
<td><img src='https://img.shields.io/badge/css3-%231572B6.svg?style=for-the-badge&logo=css3&logoColor=white' title='CSS'  height='20px'/></td><td>11693247</td>
<td><img src='https://img.shields.io/badge/_-Makefile -11DDDD.svg?style=for-the-badge' title='Makefile'  height='20px'/></td><td>478387</td>
</tr><tr>
...
<tr>
            ...
            <td>
              ...
              <p>Apache License 2.0</p>
              <p><h4>Recent Activity</h4><ul><li><a href='https://github.com/dmzoneill/Seedarr/issues/430'>fix(encryption): fix IA buffer size limit to 65535 bytes and pipeline outgoing BitTorrent handshakes in MSE IA payload</a></li></ul></p>
