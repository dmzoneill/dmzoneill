<a href="https://github.com/dmzoneill" target="_blank"><img alt="Github" src="https://img.shields.io/badge/GitHub-%2312100E.svg?&style=for-the-badge&logo=Github&logoColor=white" /></a> &nbsp;&nbsp; <a href="https://www.linkedin.com/in/dmzoneill/" target="_blank"><img alt="LinkedIn" src="https://img.shields.io/badge/linkedin-%230077B5.svg?&style=for-the-badge&logo=linkedin&logoColor=white" /></a> &nbsp;&nbsp; <img alt="Github" src="https://img.shields.io/badge/Last%20Updated-18/09/2026 18:10:57-brightgreen" height='28'/> &nbsp;&nbsp; <img alt="Profile Views" src="https://komarev.com/ghpvc/?username=dmzoneill&color=brightgreen&style=for-the-badge" height='28'/> &nbsp;&nbsp; <img alt="Redhat" width='30' height='25' src="https://github.com/dmzoneill/dmzoneill/blob/main/images/redhat.svg?raw=true" />
...
<ul><li><a href='https://github.com/dmzoneill/Seedarr/issues/197'>fix(statemachine): persist stopped status to database when ratio or seeding limits are reached</a></li><li><a href='https://github.com/dmzoneill/ansible-feeditout-com/issues/454'>[ALERT] SystemdUnitFailed — </a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/348'>fix(emulation): implement file priority and wanted/unwanted persistence in QBittorrentApiController and TransmissionRpcController</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/492'>security(extraction): enforce Zip-Slip path canonicalization, pre-extraction disk space verification, and post-import cleanup</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/225'>fix(pex): wire PeerExchange to PeerServer Extended message handler to send and receive PEX</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/263'>fix(automation): execute banPeer action in AutomationService, terminate active peer connections, and publish PeerBannedEvent</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/200'>fix(seeding): prevent StartAll from marking incomplete downloads as Seeding and handle Paused/Downloading states</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/196'>fix(telemetry): eliminate duplicate SignalR query invalidation, resync on reconnect, and fix speed delta calculation in StatusBar and SpeedGraph</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/161'>fix(automation): execute dropped pipeline actions (recheck, reannounce, trackers, webhooks) and fix progress scale mismatch</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/209'>fix(ui): bind BandwidthCard sliders to alternative speed limits when Turtle Mode is active</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/208'>fix(bandwidth): prevent scheduled speed boost nullification in SpeedPolicy and enforce aggregate global limit clamping</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/217'>fix(navigation): support select query parameter in TorrentIndex to enable Command Palette deep-linking</a></li><li><a href='https://github.com/dmzoneill/ansible-feeditout-com/issues/454'>[ALERT] SystemdUnitFailed — </a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/298'>fix(signalr): wire accessTokenFactory in SignalR client to authenticate WebSocket connections via API key</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/165'>fix(trackers): parse BEP 15 error string in UdpTrackerProvider instead of reporting unexpected action</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/270'>fix(categories): wire category SavePath override to torrent storage and support string category in setcategory</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/157'>fix(scripts): remove duplicate lifecycle script execution and add process reaping / interpreter support</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/364'>fix(ui): resolve NaN comparator breakdown and invert inactive ETA in TorrentTable column sorting</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/241'>fix(trackerserver): support BEP 7 IPv6 compact peers (peers6) and prevent discarding IPv6 peers</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/271'>fix(utp): implement dynamic RTO calculation with exponential backoff to eliminate 50ms retransmit storms</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/185'>fix(arrintegration): support query/bearer auth in WebhookReceiverController and case-insensitive ArrType in ArrWebhookRegistration</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/363'>fix(indexers): decode HTML entities and CDATA character references in release titles and descriptions</a></li><li><a href='https://github.com/dmzoneill/ansible-feeditout-com/issues/454'>[ALERT] SystemdUnitFailed — </a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/299'>fix(signalr): broadcast TaskCompleted and CommandCompleted events and invalidate SystemTasks queries</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/171'>fix(mediaenrichment): prevent DeleteLocalFile from deleting user files outside AppData on torrent removal</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/279'>fix(speedschedule): enforce rule priority precedence instead of minimum speed mixing in SpeedScheduler</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/184'>fix(notifications): handle string boolean in EmailNotificationSender SSL settings and use Category fallback</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/187'>fix(update): prevent synchronous network blocking in UpdateCheck and implement rate-limit backoff</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/214'>fix(proxy): add dynamic handler reconfiguration to HttpTrackerProvider on proxy setting changes</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/400'>fix(lpd): implement multihomed interface multicast binding and client cookie loopback filtering</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/155'>fix(sqlite): eliminate Cache=Shared concurrency deadlocks and enforce per-connection pragmas</a></li></ul>
</details>
<details>
...
<table width='100%' style='width:100%'>
  ...
  <tbody>
    <tr><td><img src='https://img.shields.io/badge/c%23-%23239120.svg?style=for-the-badge&logo=c-sharp&logoColor=white' title='C#'  height='20px'/></td><td>17929674</td>
<td><img src='https://img.shields.io/badge/typescript-%23007ACC.svg?style=for-the-badge&logo=typescript&logoColor=white' title='TypeScript'  height='20px'/></td><td>12125151</td>
...
<td><img src='https://img.shields.io/badge/_-Makefile -11DDDD.svg?style=for-the-badge' title='Makefile'  height='20px'/></td><td>478507</td>
</tr><tr>
...
<tr>
            ...
            <td>
              ...
              <p>Apache License 2.0</p>
              <p><h4>Recent Activity</h4><ul><li><a href='https://github.com/dmzoneill/Seedarr/issues/197'>fix(statemachine): persist stopped status to database when ratio or seeding limits are reached</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/348'>fix(emulation): implement file priority and wanted/unwanted persistence in QBittorrentApiController and TransmissionRpcController</a></li></ul></p>
              <p><h4>Issues</h4><ul><li><a href='https://github.com/dmzoneill/Seedarr/issues/521'>feat(torrents): detect swarm piece extinction and transition to StalledNoSeeds when missing pieces have zero availability</a> 2026-09-18</li><li><a href='https://github.com/dmzoneill/Seedarr/issues/519'>feat(pieces): implement incremental swarm piece frequency histogram with O(1) rarity bucket tracking</a> 2026-09-18</li><li><a href='https://github.com/dmzoneill/Seedarr/issues/515'>security(marketplace): implement cryptographic template signature verification and input schema validation in AutomationMarketplaceService</a> 2026-09-18</li><li><a href='https://github.com/dmzoneill/Seedarr/issues/513'>security(automation): enforce strict JavaScript sandboxing, SSRF guards, and disable unconstrained process execution in JintScriptRunner</a> 2026-09-18</li><li><a href='https://github.com/dmzoneill/Seedarr/issues/479'>perf(peers): replace blocking synchronous socket I/O with asynchronous ValueTask streaming and eliminate ArrayPool buffer allocations</a> 2026-09-18</li></ul></p>
              <p><h4>Pull Requests</h4><ul><li><a href='https://github.com/dmzoneill/Seedarr/pull/102'>chore(deps-dev): bump fast-uri from 3.1.5 to 3.1.7 in /src/Seedarr.Frontend</a> 2026-09-18</li></ul></p>
            </td>
            <td>
              <p><a href='' title=''></a></p>
            </td>
