<a href="https://github.com/dmzoneill" target="_blank"><img alt="Github" src="https://img.shields.io/badge/GitHub-%2312100E.svg?&style=for-the-badge&logo=Github&logoColor=white" /></a> &nbsp;&nbsp; <a href="https://www.linkedin.com/in/dmzoneill/" target="_blank"><img alt="LinkedIn" src="https://img.shields.io/badge/linkedin-%230077B5.svg?&style=for-the-badge&logo=linkedin&logoColor=white" /></a> &nbsp;&nbsp; <img alt="Github" src="https://img.shields.io/badge/Last%20Updated-04/09/2026 00:21:05-brightgreen" height='28'/> &nbsp;&nbsp; <img alt="Profile Views" src="https://komarev.com/ghpvc/?username=dmzoneill&color=brightgreen&style=for-the-badge" height='28'/> &nbsp;&nbsp; <img alt="Redhat" width='30' height='25' src="https://github.com/dmzoneill/dmzoneill/blob/main/images/redhat.svg?raw=true" />
...
<ul><li><a href='https://github.com/dmzoneill/ansible-feeditout-com/issues/454'>[ALERT] SystemdUnitFailed — </a></li><li><a href='https://github.com/dmzoneill/ansible-feeditout-com/issues/454'>[ALERT] SystemdUnitFailed — </a></li><li><a href='https://github.com/dmzoneill/ansible-feeditout-com/issues/454'>[ALERT] SystemdUnitFailed — </a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/55'>Bug: CookieSessionManager fails to slide database session expiry and updates neither LastActivity nor Expiry, causing premature session invalidation and SQLite connection thrashing</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/54'>Bug: TorznabClient fails to parse freeleech attributes and unescaped XML, while RssSyncService has substring category matching and unpersisted deduplication</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/53'>RPC Compatibility: Transmission RPC torrent-add rejects local file paths and fails to return torrent-duplicate for existing torrents</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/50'>Security: Server-Side Request Forgery (SSRF) and data exfiltration via MediaEnrichmentService artwork caching</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/59'>Media Enrichment: Flawed Movie vs TV heuristics and unstripped episode numbers break TMDB and Sonarr lookups</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/52'>Bug: TorrentFileParser allows malformed piece counts and negative lengths causing OverflowException crash in PiecePicker</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/58'>Media Inspection: MediaInfoInspectorProvider unconsumed stderr stream deadlock and threadpool blocking</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/49'>Bug: PiecePicker unbounded in-flight block retention causes permanent download stalls when peers drop or choke</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/57'>Servarr & Notifications: NotificationEventHandler passes JSON settings as URL crashing Telegram and Pushover dispatches</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/48'>Bug: torrent-set-location and setLocation fail to move files on disk or update active download engine save path</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/23'>Media Enrichment: Reconnect dynamic media metadata providers to MediaEnrichmentService and fix artwork caching</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/22'>SignalR: Batch piece verification broadcasts and implement bounded telemetry backpressure</a></li><li><a href='https://github.com/dmzoneill/ansible-feeditout-com/issues/454'>[ALERT] SystemdUnitFailed — </a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/21'>Media Inspection: Prevent pipe buffer deadlocks in CLI inspectors/extractors and fix EBML stream safety</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/20'>Performance: Eliminate N+1 queries on polling endpoints and implement delta sync for qBittorrent</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/19'>Performance: SQLite WAL mode, transactional batching, and missing foreign key indexes</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/47'>Bug: Indexer and Arr connection Test buttons send unnormalized payload causing HTTP 400 Bad Request</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/18'>Reliability: Eliminate async void in engine event handlers and unobserved task exceptions in TrackerBoost</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/17'>Architecture: Fix dual singleton instantiation for dynamic proxy managers in Bootstrap.cs</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/16'>Core Engine: Torrents remain stuck in 'Downloading' state on completion due to unhandled TorrentDownloadCompletedEvent</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/47'>Bug: Indexer and Arr connection Test buttons send unnormalized payload causing HTTP 400 Bad Request</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/37'>Security: SAML 2.0 XML Signature Wrapping (XSW) authentication bypass and open redirects in AuthController</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/15'>Security: Close unauthenticated RPC access on compatibility controllers and fix ForwardAuth private network fallback</a></li><li><a href='https://github.com/dmzoneill/ansible-feeditout-com/issues/454'>[ALERT] SystemdUnitFailed — </a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/14'>Security: Fail-closed VPN kill-switch implementation to prevent socket leaks over unencrypted interfaces</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/41'>Bug: Decoupled cookie tickets prevent session revocation and expired sessions leak indefinitely in database</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/36'>Security: Unauthenticated remote access on 11 compatibility RPC controllers</a></li></ul>
</details>
<details>
...
<table width='100%' style='width:100%'>
  ...
  <tbody>
    <tr><td><img src='https://img.shields.io/badge/c%23-%23239120.svg?style=for-the-badge&logo=c-sharp&logoColor=white' title='C#'  height='20px'/></td><td>8512099</td>
<td><img src='https://img.shields.io/badge/typescript-%23007ACC.svg?style=for-the-badge&logo=typescript&logoColor=white' title='TypeScript'  height='20px'/></td><td>4356126</td>
<td><img src='https://img.shields.io/badge/css3-%231572B6.svg?style=for-the-badge&logo=css3&logoColor=white' title='CSS'  height='20px'/></td><td>11640414</td>
<td><img src='https://img.shields.io/badge/shell_script-%23121011.svg?style=for-the-badge&logo=gnu-bash&logoColor=white' title='Shell'  height='20px'/></td><td>2692148</td>
</tr><tr>
...
<td><img src='https://img.shields.io/badge/JavaScript-F7DF1E?style=for-the-badge&logo=javascript&logoColor=black' title='JavaScript'  height='20px'/></td><td>19225751</td>
...
<tr>
            ...
            <td>
              ...
              <p>Apache License 2.0</p>
              <p><h4>Recent Activity</h4><ul><li><a href='https://github.com/dmzoneill/Leecharr/issues/55'>Bug: CookieSessionManager fails to slide database session expiry and updates neither LastActivity nor Expiry, causing premature session invalidation and SQLite connection thrashing</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/54'>Bug: TorznabClient fails to parse freeleech attributes and unescaped XML, while RssSyncService has substring category matching and unpersisted deduplication</a></li></ul></p>
              <p><h4>Issues</h4><ul><li><a href='https://github.com/dmzoneill/Leecharr/issues/62'>Frontend: ConnectionsTab Arr sync displays undefined counts due to SyncResultResource DTO mismatch</a> 2026-09-04</li><li><a href='https://github.com/dmzoneill/Leecharr/issues/61'>Frontend: Unhandled promise rejection in LogTab clipboard copy and missing dismiss handlers in table column customizer</a> 2026-09-04</li><li><a href='https://github.com/dmzoneill/Leecharr/issues/60'>Indexers: ProwlarrSyncService and TorznabClient lack capabilities (t=caps) XML parsing and category synchronization</a> 2026-09-04</li><li><a href='https://github.com/dmzoneill/Leecharr/issues/56'>Bug: QBittorrentSearchService activeJobs dictionary leaks memory and CancellationTokenSource handles indefinitely without TTL or eviction</a> 2026-09-04</li><li><a href='https://github.com/dmzoneill/Leecharr/issues/51'>Security: Incomplete SSRF and unbounded memory remediation across remaining RPC controllers and REST endpoints</a> 2026-09-04</li></ul></p>
              <p><ul></ul></p>
            </td>
            <td>
              <p><a href='' title=''></a></p>
