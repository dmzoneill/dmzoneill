<a href="https://github.com/dmzoneill" target="_blank"><img alt="Github" src="https://img.shields.io/badge/GitHub-%2312100E.svg?&style=for-the-badge&logo=Github&logoColor=white" /></a> &nbsp;&nbsp; <a href="https://www.linkedin.com/in/dmzoneill/" target="_blank"><img alt="LinkedIn" src="https://img.shields.io/badge/linkedin-%230077B5.svg?&style=for-the-badge&logo=linkedin&logoColor=white" /></a> &nbsp;&nbsp; <img alt="Github" src="https://img.shields.io/badge/Last%20Updated-14/09/2026 00:25:28-brightgreen" height='28'/> &nbsp;&nbsp; <img alt="Profile Views" src="https://komarev.com/ghpvc/?username=dmzoneill&color=brightgreen&style=for-the-badge" height='28'/> &nbsp;&nbsp; <img alt="Redhat" width='30' height='25' src="https://github.com/dmzoneill/dmzoneill/blob/main/images/redhat.svg?raw=true" />
...
<ul><li><a href='https://github.com/dmzoneill/Leecharr/issues/714'>fix(security): add protected path and root deletion guard to FileBrowserService</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/138'>fix(resilience): add root ErrorBoundary and ProblemDetails exception handling in Startup.cs</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/132'>feat(auth): implement LoginPage with session routing and support Basic/Forward-Auth handlers in SmartAuth</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/131'>fix(security): enforce authentication on SignalR MessageHub and WebSocket connections</a></li><li><a href='https://github.com/dmzoneill/ansible-feeditout-com/issues/454'>[ALERT] SystemdUnitFailed — </a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/711'>docs(swagger): enable IncludeXmlComments in Startup.cs for Leecharr API documentation</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/709'>feat(automation): implement periodic background watchdog for orphaned automation triggers</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/724'>fix(proxy): resolve SOCKS4 unsupported exception, add RFC1918 LAN bypass, and wire config to HTTP transport providers</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/128'>feat(automation): implement periodic background watchdog for orphaned automation triggers</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/125'>fix(proxy): connect IProxySettingsProvider to HttpTrackerProvider, IndexerController, and PeerConnection</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/715'>fix(settings): render UI controls or clean up unrendered form state in EngineSettingsTab and ClientEmulationSettingsTab</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/721'>feat(category): automatically create save directory on disk and verify writability on save</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/130'>cleanup(frontend): remove or integrate orphaned History.tsx component</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/129'>fix(system): replace hardcoded migration version 015 with dynamic LatestMigration</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/127'>fix(signalr): harmonize SignalRProvider named event subscriptions with backend broadcaster</a></li><li><a href='https://github.com/dmzoneill/ansible-feeditout-com/issues/454'>[ALERT] SystemdUnitFailed — </a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/718'>fix(torrentcreator): support BEP 19 url-list webseeds, preserve multi-tracker tiers, and add source tag</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/708'>fix(transmission): populate real webseeds and dynamic peersFrom discovery metrics in TransmissionRpcController</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/707'>feat(rtorrent): implement p.multicall XML-RPC method for peer statistics</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/706'>fix(aria2): implement missing switch handlers for aria2.changeUri, aria2.shutdown, and aria2.forceShutdown</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/141'>fix(trackerboost): implement strict BEP 15 16-byte connect response and transactionId matching in UDP health probe</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/126'>fix(trackerserver): wire IncrementAnnounces and IncrementScrapes to HTTP and UDP tracker request handlers</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/733'>fix(telemetry): standardize peer flag mappings and Azureus client ID parsing in PeerClientBadge and PeersTab</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/135'>fix(telemetry): pass countryCode and countryName to CountryFlag in PeersTab</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/151'>fix(geoip): add GeoIP resolution service and populate PeerResource telemetry for PeerMap and CountryFlag</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/150'>fix(choking): implement ChokeManager with optimistic unchoke rotation and enforce MaxUploadSlots</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/149'>fix(protocol): parse reserved handshake bytes and handle Have/Bitfield/Cancel/Choke and BEP 6 Fast Extension in PeerServer</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/737'>fix(notifications): parse Discord/Telegram HTTP 429 Retry-After and prevent unescaped JSON injection in YAML runner</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/735'>fix(engine): restore stored file priorities to PiecePicker on engine startup and respect priorities in sequential mode</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/734'>fix(bandwidth): fix manual Alternative Speed precedence and prevent per-torrent fallback to global rate limit</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/732'>feat(category): add write permission check, path validation, and automatic data relocation on category change</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/731'>fix(filebrowser): add archive extraction, symlink loop guard, and path traversal / root delete safety</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/730'>fix(diskprovider): fix Windows volume mount point matching and deduplicate physical drives in DiskSpaceService</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/729'>feat(storage): expose LowDiskSpaceThresholdMb in Settings UI and publish DiskSpaceLow/Critical events</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/728'>fix(indexer): implement IndexerStatusService with exponential backoff on 429/503 and Torznab total count</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/727'>fix(rtorrent): add deleteFiles support to d.erase and d.delete XML-RPC methods</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/726'>fix(webhooks): handle Grab and DownloadFailed/ImportFailed events with TLS validation options</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/725'>fix(automation): fix isComplete scale bug, UI sampleTorrent variable generator, and dispatch dropped actions</a></li></ul>
</details>
<details>
...
<table width='100%' style='width:100%'>
  ...
  <tbody>
    <tr><td><img src='https://img.shields.io/badge/typescript-%23007ACC.svg?style=for-the-badge&logo=typescript&logoColor=white' title='TypeScript'  height='20px'/></td><td>11669416</td>
<td><img src='https://img.shields.io/badge/c%23-%23239120.svg?style=for-the-badge&logo=c-sharp&logoColor=white' title='C#'  height='20px'/></td><td>13512891</td>
<td><img src='https://img.shields.io/badge/css3-%231572B6.svg?style=for-the-badge&logo=css3&logoColor=white' title='CSS'  height='20px'/></td><td>11692017</td>
...
<td><img src='https://img.shields.io/badge/docker-%230db7ed.svg?style=for-the-badge&logo=docker&logoColor=white' title='Dockerfile'  height='20px'/></td><td>17872</td>
</tr><tr>
...
<tr>
            <td>
              ...
              <p>Apache License 2.0</p>
              <p><ul></ul></p>
              <p><h4>Issues</h4><ul><li><a href='https://github.com/dmzoneill/lidarr-youtube-downloader/issues/31'>Question:  Can I send my own artist and album?</a> 2026-09-12</li><li><a href='https://github.com/dmzoneill/lidarr-youtube-downloader/issues/29'>[FR] Only search for missing songs from artists with a given tag</a> 2026-09-12</li><li><a href='https://github.com/dmzoneill/lidarr-youtube-downloader/issues/28'>Stuck?</a> 2026-09-12</li><li><a href='https://github.com/dmzoneill/lidarr-youtube-downloader/issues/25'>Most releases found are missing tracks</a> 2026-09-12</li><li><a href='https://github.com/dmzoneill/lidarr-youtube-downloader/issues/23'>Track Format & FFMPEG not adding metadata</a> 2026-09-12</li></ul></p>
              <p><ul></ul></p>
            </td>
            <td>
...
<tr>
            ...
            <td>
              ...
              <p>Apache License 2.0</p>
              <p><h4>Recent Activity</h4><ul><li><a href='https://github.com/dmzoneill/Leecharr/issues/714'>fix(security): add protected path and root deletion guard to FileBrowserService</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/711'>docs(swagger): enable IncludeXmlComments in Startup.cs for Leecharr API documentation</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/709'>feat(automation): implement periodic background watchdog for orphaned automation triggers</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/724'>fix(proxy): resolve SOCKS4 unsupported exception, add RFC1918 LAN bypass, and wire config to HTTP transport providers</a></li></ul></p>
              <p><ul></ul></p>
              <p><ul></ul></p>
            </td>
            <td>
...
<tr>
            <td>
              ...
              <p>Apache License 2.0</p>
              <p><h4>Recent Activity</h4><ul><li><a href='https://github.com/dmzoneill/Seedarr/issues/138'>fix(resilience): add root ErrorBoundary and ProblemDetails exception handling in Startup.cs</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/132'>feat(auth): implement LoginPage with session routing and support Basic/Forward-Auth handlers in SmartAuth</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/131'>fix(security): enforce authentication on SignalR MessageHub and WebSocket connections</a></li><li><a href='https://github.com/dmzoneill/Seedarr/issues/128'>feat(automation): implement periodic background watchdog for orphaned automation triggers</a></li></ul></p>
              <p><ul></ul></p>
              <p><ul></ul></p>
            </td>
            <td>
