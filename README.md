<a href="https://github.com/dmzoneill" target="_blank"><img alt="Github" src="https://img.shields.io/badge/GitHub-%2312100E.svg?&style=for-the-badge&logo=Github&logoColor=white" /></a> &nbsp;&nbsp; <a href="https://www.linkedin.com/in/dmzoneill/" target="_blank"><img alt="LinkedIn" src="https://img.shields.io/badge/linkedin-%230077B5.svg?&style=for-the-badge&logo=linkedin&logoColor=white" /></a> &nbsp;&nbsp; <img alt="Github" src="https://img.shields.io/badge/Last%20Updated-08/09/2026 12:14:21-brightgreen" height='28'/> &nbsp;&nbsp; <img alt="Profile Views" src="https://komarev.com/ghpvc/?username=dmzoneill&color=brightgreen&style=for-the-badge" height='28'/> &nbsp;&nbsp; <img alt="Redhat" width='30' height='25' src="https://github.com/dmzoneill/dmzoneill/blob/main/images/redhat.svg?raw=true" />
...
<ul><li><a href='https://github.com/dmzoneill/Leecharr/issues/494'>[Torrents / Progress] TorrentFileProgressEnricher prematurely reports 100% progress and full file size for incomplete files</a></li><li><a href='https://api.github.com/repos/dmzoneill/Leecharr'>dmzoneill/Leecharr</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/496'>[PowerManagement] Windows SetSuspendState via rundll32 hibernates instead of suspending and macOS osascript shutdown fails due to literal quotes</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/493'>[Security / Reverse Proxy] HostHeaderValidationMiddleware rejects bracketed IPv6, IPv6 private/link-local/ULA ranges, CGNAT, and wildcard hostnames</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/497'>[Security / SSL] CertificateManager fails to include intermediate CA certificate chains from PEM and breaks on Windows Schannel</a></li><li><a href='https://api.github.com/repos/dmzoneill/Leecharr'>dmzoneill/Leecharr</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/495'>[Security / CSRF] CsrfProtectionMiddleware.IsAuthPath substring matching allows arbitrary endpoints containing auth paths to bypass CSRF validation</a></li><li><a href='https://api.github.com/repos/dmzoneill/Leecharr'>dmzoneill/Leecharr</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/501'>[Security / Auth] JitUserProvisioningService automatic account linking by unverified username/email allows cross-IdP account hijacking and unsanitized avatar URLs</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/503'>[AI / Heuristics] RuleHeuristicAiProvider corrupts titles containing years and aggressively strips common English words from natural search queries</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/502'>[Security / OIDC] IdentityProviderConfigController drops valid client secrets containing asterisks during update</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/510'>[AI / LLM] JsonElement.GetBoolean() and unescaped URI parameters in CloudGeminiAiProvider and OllamaAiProvider throw InvalidOperationException on non-boolean or null JSON tokens</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/498'>[PTY / Lifecycle] PtyProcessSession leaks orphaned child shell processes and creates zombie processes on disconnect</a></li><li><a href='https://api.github.com/repos/dmzoneill/Leecharr'>dmzoneill/Leecharr</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/499'>[RPC / qBittorrent] toggleSpeedLimitsMode and setSpeedLimitsMode bypass SpeedSchedulerService hierarchy and overwrite active scheduled rate limits</a></li><li><a href='https://api.github.com/repos/dmzoneill/Leecharr'>dmzoneill/Leecharr</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/509'>[BitTorrent / Swarm] MonoTorrentDownloadEngine.GetPeers omits standard transfer flags (D, d, U, u, P) causing incorrect peer state and uTP badge detection</a></li><li><a href='https://api.github.com/repos/dmzoneill/Leecharr'>dmzoneill/Leecharr</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/511'>[AI / Config] AiConfigController fire-and-forget provider switch desynchronizes ActiveAiProvider database setting from runtime engine on health check failure</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/508'>[Frontend / React Query] useBoostTorrent and useInjectTrackerToTorrent invalidate nonexistent query key ["trackers", torrentId] and omit ["torrents", torrentId, "trackers"]</a></li><li><a href='https://github.com/dmzoneill/ansible-feeditout-com/issues/454'>[ALERT] SystemdUnitFailed — </a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/507'>[Frontend / Settings] SelectInput option values pass localized i18n translation strings instead of invariant protocol identifiers in DownloadClientsTab, IndexersTab, LoggingTab, and QueueSettingsTab</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/507'>[Frontend / Settings] SelectInput option values pass localized i18n translation strings instead of invariant protocol identifiers in DownloadClientsTab, IndexersTab, LoggingTab, and QueueSettingsTab</a></li><li><a href='https://api.github.com/repos/dmzoneill/Leecharr'>dmzoneill/Leecharr</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/504'>[Datastore / PostgreSQL] DownloadHistoryRepository.GetHistory uses case-sensitive LIKE resulting in missed search results on PostgreSQL</a></li><li><a href='https://api.github.com/repos/dmzoneill/Leecharr'>dmzoneill/Leecharr</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/500'>[Security / Auth] UserService.UpdatePassword, Delete, and role updates fail to invalidate active UserSessions and in-memory session cache</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/506'>[REST / Config] ConfigControllerBase.SaveConfig throws unhandled NullReferenceException/ArgumentNullException on null or empty PUT body</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/505'>[Datastore] DbFactory.Create omits type handlers and TableRegistration leading to invalid table names and unmapped collection properties</a></li><li><a href='https://github.com/dmzoneill/ansible-feeditout-com/issues/454'>[ALERT] SystemdUnitFailed — </a></li><li><a href='https://github.com/dmzoneill/ansible-feeditout-com/issues/454'>[ALERT] SystemdUnitFailed — </a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/521'>[BitTorrent / Network Binding] VpnKillSwitchService and MonoTorrentDownloadEngine resolve non-routable link-local IPv6 address for listening endpoint</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/571'>[BitTorrent / Engines] Complete sidecar engine tracker/file controls, peer parsing, and dynamic NAT-PMP mappings</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/572'>[Security / SignalR] Exempt RPC compatibility routes from CSRF enforcement and broadcast subsystem switch events</a></li></ul>
</details>
<details>
...
<table width='100%' style='width:100%'>
  ...
  <tbody>
    <tr><td><img src='https://img.shields.io/badge/typescript-%23007ACC.svg?style=for-the-badge&logo=typescript&logoColor=white' title='TypeScript'  height='20px'/></td><td>9390627</td>
<td><img src='https://img.shields.io/badge/c%23-%23239120.svg?style=for-the-badge&logo=c-sharp&logoColor=white' title='C#'  height='20px'/></td><td>11380259</td>
<td><img src='https://img.shields.io/badge/css3-%231572B6.svg?style=for-the-badge&logo=css3&logoColor=white' title='CSS'  height='20px'/></td><td>11650588</td>
...
<td><img src='https://img.shields.io/badge/shell_script-%23121011.svg?style=for-the-badge&logo=gnu-bash&logoColor=white' title='Shell'  height='20px'/></td><td>2693399</td>
<td><img src='https://img.shields.io/badge/docker-%230db7ed.svg?style=for-the-badge&logo=docker&logoColor=white' title='Dockerfile'  height='20px'/></td><td>17598</td>
<td><img src='https://img.shields.io/badge/_-Makefile -11DDDD.svg?style=for-the-badge' title='Makefile'  height='20px'/></td><td>473127</td>
</tr><tr>
...
<tr>
            ...
            <td>
              ...
              <p>Apache License 2.0</p>
              <p><h4>Recent Activity</h4><ul><li><a href='https://github.com/dmzoneill/Leecharr/issues/494'>[Torrents / Progress] TorrentFileProgressEnricher prematurely reports 100% progress and full file size for incomplete files</a></li><li><a href='https://api.github.com/repos/dmzoneill/Leecharr'>dmzoneill/Leecharr</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/496'>[PowerManagement] Windows SetSuspendState via rundll32 hibernates instead of suspending and macOS osascript shutdown fails due to literal quotes</a></li><li><a href='https://github.com/dmzoneill/Leecharr/issues/493'>[Security / Reverse Proxy] HostHeaderValidationMiddleware rejects bracketed IPv6, IPv6 private/link-local/ULA ranges, CGNAT, and wildcard hostnames</a></li></ul></p>
              <p><h4>Issues</h4><ul><li><a href='https://github.com/dmzoneill/Leecharr/issues/612'>[Deluge / Status & Config] Implement 25+ missing status keys, fix num_peers counting, and expand core.get_config preferences</a> 2026-09-08</li><li><a href='https://github.com/dmzoneill/Leecharr/issues/611'>[Deluge / RPC] Support canonical _session_id cookie, JSON-RPC 200 error envelope, and composite filter trees</a> 2026-09-08</li><li><a href='https://github.com/dmzoneill/Leecharr/issues/610'>[Media Cache / Webhooks] Add thumbnail downsampling, prune orphan pre-enrichment cache directories, and format nested webhook payload schema</a> 2026-09-08</li><li><a href='https://github.com/dmzoneill/Leecharr/issues/609'>[Media Enrichment / Servarr] Implement exact 1:1 queue/history download hash correlation, ArrMediaId persistence, and MusicBrainz schema</a> 2026-09-08</li><li><a href='https://github.com/dmzoneill/Leecharr/issues/608'>[Indexers / Capabilities] Implement t=caps TTL cache, XML namespace resilience, and Newznab Usenet parameter mappings</a> 2026-09-08</li></ul></p>
              <p><ul></ul></p>
            </td>
            <td>
              <p><a href='' title=''></a></p>
